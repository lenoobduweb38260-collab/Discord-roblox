...
// Le même trait que celui posé par l'identité : `cartes.js` le reconnaît et
// le remplace par un séparateur natif.
const BARRE = M.SEPARATEUR;
...
module.exports = { appliquer, AIDE, EXEMPLE, BARRE };
