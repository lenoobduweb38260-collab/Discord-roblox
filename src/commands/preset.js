  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((sub) =>
      sub
        ...
        .addStringOption((o) => o.setName('message').setDescription('Texte envoyé (\\n = saut de ligne)').setRequired(false))
        .addStringOption((o) => o.setName('titre').setDescription('Titre de l\'embed (facultatif)').setRequired(false))
        .addStringOption((o) => o.setName('description').setDescription('Texte de l\'embed (facultatif)').setRequired(false))
    ...
    .addSubcommand((sub) =>
      sub
        ...
        .addStringOption((o) => o.setName('message').setDescription('Nouveau texte (« - » pour vider)').setRequired(false))
        .addStringOption((o) => o.setName('titre').setDescription('Nouveau titre d\'embed (« - » pour vider)').setRequired(false))
        .addStringOption((o) => o.setName('description').setDescription('Nouveau texte d\'embed (« - » pour vider)').setRequired(false))
